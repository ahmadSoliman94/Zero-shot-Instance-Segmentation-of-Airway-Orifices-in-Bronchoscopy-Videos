# https://github.com/voxelmorph/voxelmorph/blob/dev/voxelmorph/torch/modelio.py
...
class LoadableModel(nn.Module):  # TODO MU & SIGMA in children model
    """
    ...
    def load(cls, path, device):
        ...
        model = cls(**checkpoint['config']).to(torch.device(device))
